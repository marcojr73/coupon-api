...
- POST `/auth/sign-up`
  ...
  - Recebe um UserRequestDto `interface/user/dto/UserRequestDto` no corpo da requisição
...
- POST `/auth/sign-in`
  ...
  - Recebe um UserSignInRequestDto `interface/user/dto/UserSignInRequestDto` no corpo da requisição
